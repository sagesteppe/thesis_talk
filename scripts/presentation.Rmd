...
subtitle: of Pollen Loads Offers Insights on<br>the Foraging Patterns of Queen Bumble Bees
---

<script>
slides > slide.title-slide {
    background-image: url('../graphics/pictures/collecting.jpg');
...
<div class="columns-2">
  ...
  ![Norm](../graphics/pictures/norm-wickett.jpg){height=55%, width=55%}
...
<center>
![<font size="4">*Rhododendron* sp. Hengduan Mtns., by Qin Li</font>](../graphics/pictures/Rhododendron_QinLi.jpg){height=50%, width=50%}
</center>
</div>
...
- 2-stage approach  
  - 1^st^: distance search of records from museums & plot based data (e.g. Forest Servce)
