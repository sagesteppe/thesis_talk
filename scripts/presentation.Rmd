...
<div class="columns-2">
  ...
  ![<font size="4">*Solidago spathulata* & *Megachile wheeleri*, by A. Litz</font>](../graphics/pictures/Megachile_Solidago.resized.jpg){height=87%, width=87%}
</div>
...
<div class="columns-2">
  ...
  ![<font size="4">Five Astragali</font>](../graphics/pictures/Five_Astragali.jpg){height=90%, width=90%}
</div>
...
- genomic
  - low cost
- how to reference backbone system
...
![](../graphics/pictures/Angiosperms353.jpg){height=95%, width=95%}
...
<div class="rows-2">
  ...
  - flowering time provides a filter for pollination studies 

<center>
![<font size="4">*Rhododendron* Hengduan Mtns., by Qin Li</font>](../graphics/pictures/Rhododendron_QinLi.jpg){height=75%, width=75%}
</center>
</div>

## are a353 semi-quantitative? - 2.4 {.flexbox .vcenter}
...
- quantify importance of interactions *awesome*
...
<div class="columns-2">
  ...
  ![<font size="4">FPNW 2^nd^</font>](../graphics/pictures/fpnw2.resized.jpg){height=83%}
</div>


## custom sequence databases - 3.2 {.flexbox .vcenter}
...
![](../graphics/plots/siteMaps.png){height=95%, width=95%}
...
<div class="columns-2">
  ...
  ![<font size="4">workflow</font>](../graphics/assorted/mircoscopy_workflow.resized.png){height=93%, width=93%}
</div>
...
<div class="columns-2">
  ...
  ![](../graphics/pictures/pollen_montage.png){height=75%, width=75%}
</div>
...
<div class="columns-2">
  ...
  <center>
  ![<font size="4">Corbiculae Sample</font>](../graphics/pictures/corbiculae_slide.resized.jpg){height=45%, width=45%}
  </center>
</div>
...
<div class="columns-2">
  ...
  ![](../graphics/assorted/molecular_metagenomic_workflow.resized.png)
</div>
...
<div class="rows-2">
  ...
  <center>
  ![<font size="4">tissue from Rocky Mountain Herbarium</font>](../graphics/pictures/Bernie_Tissue.jpg){height=65%, width=65%}
  </center>
...
<div class="columns-2">  
  ...
  - 44 samples underwent all steps  
...
<div class="rows-2">
  ...
  ![<font size="4">flower dates</font>](../graphics/plots/phenology_estimates-jeo_10_90.png){height=92%, width=92%}
</div>
...
We were not able to establish a database with nearly as much data as we hoped to. Kew was meant to have released the full 14k species worth of data already, but then COVID. Nonetheless, we had pretty good coverage for our purposes. We were able to establish a database of 155 species. We expect around the time this work is pubished, KEW will have released the remainder of these data. 
...
<div class="columns-2">
  ...
  - Blast  (least false positives)
  
  - both very fast alignment algorithms, worked well as filters to reduce the workload for BLAST
    - BLAST operates at roughly 1/1000 speed
    - more accurate algorithm

  ![<font size="4">Three Initial Networks</font>](../graphics/plots/Molecular_nets.png){height=90%, width=90%}
</div>
...
<div class="columns-2">
  ...
  ![<font size="4">Counted grains</note>](../graphics/plots/CorrelationCountedSequences.png){height=92%, width=92%}
</div>
...
## conservation implications - 6.1 - I
